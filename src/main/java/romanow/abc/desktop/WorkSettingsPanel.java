...
public class WorkSettingsPanel extends BasePanel{
    ...
    private void initComponents() {
        ...
        add(jLabel19);
        jLabel19.setBounds(20, 450, 260, 14);
        ...
        MainServer.setText("Сервер СУ АГЭУ");
        ...
        add(jLabel35);
        jLabel35.setBounds(20, 390, 260, 14);
        ...
        StreamDataCompressMode.setBounds(310, 440, 70, 25);
        ...
        add(Refresh);
        Refresh.setBounds(653, 420, 40, 40);
        ...
        add(UserSilenceTime);
        UserSilenceTime.setBounds(310, 470, 70, 25);

        jLabel1.setText("Время \"молчания\" оператора (мин)");
        add(jLabel1);
        jLabel1.setBounds(20, 480, 240, 14);
    ...
    private void MainServerItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_MainServerItemStateChanged
        procPressedBoolean(MainServer,"mainServer");
        updateSettings();
    ...
    public void refresh() {
        try {
            ...
            StreamDataLimit.setText(""+ws.getStreamDataPeriodLimit());
            PLMReady.setSelected(ws.isPlmConnected());
            setIPPortVisible();
